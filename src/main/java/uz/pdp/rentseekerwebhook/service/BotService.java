...
import uz.pdp.rentseekerwebhook.component.EmailComponent;
...
import uz.pdp.rentseekerwebhook.model.locationModels.LocationsItem;
import uz.pdp.rentseekerwebhook.payload.HandleSendPhoto;
import uz.pdp.rentseekerwebhook.util.enums.*;
...
import static uz.pdp.rentseekerwebhook.service.LanguageService.getWord;
import static uz.pdp.rentseekerwebhook.util.constant.Constant.*;
import static uz.pdp.rentseekerwebhook.util.enums.BotState.SHOW_HOME_PHONE_MENU_ALL;
...
public class BotService {
    ...
    public List<HandleSendPhoto> showAllHomes(Update update, Language lan) {
        ...
        List<HandleSendPhoto> sendMessageList = new ArrayList<>();
        HandleSendPhoto sendPhoto = null;
        ...
        for (Home home : allHome) {
            ...
            sendPhoto = new HandleSendPhoto(
                    message.getChatId().toString(),
                    new InputFile(home.getFileId()),
                    getCaptionByHome(home, lan),
                    markup);
    ...
    public EditMessageCaption changeHomeLike(Update update, Language lan, String backName, BotState state) {
        ...
        like = likeService.changeLike(like);
    ...
    public List<HandleSendPhoto> showSortedOptionsSend(Update update, Language lan) {
    ...
    public List<HandleSendPhoto> getMyFavouriteHomes(Update update, Language lan) {
        InlineKeyboardMarkup markup = null;
        List<List<InlineKeyboardButton>> rowList;
        List<InlineKeyboardButton> row1;
        List<InlineKeyboardButton> row2 = null;
    ...
    public List<HandleSendPhoto> getMyHomes(Update update, Language lan) {
        InlineKeyboardMarkup markup = null;
        List<List<InlineKeyboardButton>> rowList;
        List<InlineKeyboardButton> row1;
        List<InlineKeyboardButton> row2 = null;
